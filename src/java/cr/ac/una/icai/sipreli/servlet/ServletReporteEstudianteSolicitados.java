 ...
 */
public class ServletReporteEstudianteSolicitados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Integer tipo = prestamo.getElPrestamo().id.getElLibro().getIsbn();
            //HASHMAP PARA LOS PARAMETROS DEL REPORTE
            parametrosReporte.put("isbn",tipo); //***  SE PASA EL PARAMETRO AL REPORTE-> EL 1 ES EL NOMBRE DEL PAREMETRO EN EL REPORTE, EL 2 ES EL VALOR QUE VA   *******//
